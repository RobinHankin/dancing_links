...
# This file is superceded by code2.R
...
# The first four rows of data.txt are identical apart from the tabs, because these are the same piece in the same location (viz, piece wh1 in location 1).  The four rows correspond to the four orientations that this piece may adopt.

# code2.R is better documented.
